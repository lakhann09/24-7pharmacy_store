   ...
   <body>
      ...
      <nav class="navbar navbar-default">
         <div class="container-fluid" id="nav">
            <div class="navbar-header">
               <a href="adminhome.jsp" class="navbar-brand" id="nav">7*24HealthCare </a>
            </div>
      ...
      <div class="container">
         <c:if test="${param.msg == 'delProSuccess'}">
            <c:set var="message" value="Product Deleted Successful !!!"/>
         </c:if>
            ...
            <script>
               if ("${message}" !== "") {
                 $(document).ready(function() {
                   if ("${message.trim()}" === "Product Deleted Successful !!!") {
                     swal({
                       title: 'Success!',
                       text: '${message.trim()}',
                       icon: 'success'
