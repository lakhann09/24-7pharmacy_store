...
<body>
		...
		<script>
           if ("${message}" !== "") {
              ...
              // if (!localStorage.getItem("messageShown")) {
               ...
               // this line is used to remove the msg from the url
               history.replaceState({}, document.title, "${pageContext.request.contextPath}/adminhome.jsp");
	...
	<nav class="navbar navbar-expand-lg fixed-top trans-navigation">
		<div class="container">
			<a class="navbar-brand" href="adminhome.jsp">
				...
				<h3 style="color: white">24*7HealthCare</h3>
			</a>
			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav ">
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="addcategoryform">Add Category</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="deletecatcontroller">Delete Category</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="viewordercontroller">View Unconfirmed Orders</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="additemcontroller">Add Products</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="viewallproadmincontroller">View Available Products</a></li>
	...
	<div class="banner-area banner-3"
		style="background-image: url(Homepage/AdminLoginRegister/images/bg.jpg);">
					...
					<div class="row">
						<div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
							<div class="banner-content content-padding">
								<h5 style="background: none;" class="subtitle">Admin
									Dashboard</h5>
								<h1 class="banner-title">Your Control Center for Efficient
									Management and Oversight.</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-6 footer-contact">
						...
						<p>
							Rajiv Gandhi Square<br> Indore <br> India<br>
							<br> <strong>Phone:</strong> +91 8357XXXX52<br> <strong>Email:</strong>
	...
	%>
	<p style="color: red;size:">You need to login first</p>
